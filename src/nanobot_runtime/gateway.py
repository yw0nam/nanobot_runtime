...
from nanobot_runtime.services.proactive.installer import IDLE_ASYNCIO_TASK_ATTR
...
def _install_run_patch() -> None:
    ...
    :func:`nanobot_runtime.services.proactive.installer.install_idle_asyncio_task` during
